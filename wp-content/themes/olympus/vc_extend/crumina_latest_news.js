( function ( $ ) {
    window.vcCruminaLatestNewsView = vc.shortcode_view.extend( {
        $wrapper: false,
        elementTemplate: false,

        changeShortcodeParams: function ( model ) {
            var params;
            var selector = '.vc-crumina-latest-news';
            window.vcCruminaLatestNewsView.__super__.changeShortcodeParams.call( this, model );

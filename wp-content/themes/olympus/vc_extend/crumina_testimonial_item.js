( function ( $ ) {
    window.vcCruminaTestimonialItemView = vc.shortcode_view.extend( {
        $wrapper: false,
        elementTemplate: false,

        changeShortcodeParams: function ( model ) {
            var params;
            var selector = '.vc-crumina-testimonial-item';
            window.vcCruminaTestimonialItemView.__super__.changeShortcodeParams.call( this, model );

( function ( $ ) {
    window.vcCruminaTeammembersItemView = vc.shortcode_view.extend( {
        $wrapper: false,
        elementTemplate: false,

        changeShortcodeParams: function ( model ) {
            var params;
            var selector = '.vc-crumina-teammembers-item';
            window.vcCruminaTeammembersItemView.__super__.changeShortcodeParams.call( this, model );

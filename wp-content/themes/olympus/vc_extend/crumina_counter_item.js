( function ( $ ) {
    window.vcCruminaCounterItemView = vc.shortcode_view.extend( {
        $wrapper: false,
        elementTemplate: false,

        changeShortcodeParams: function ( model ) {
            var params;
            var selector = '.vc-crumina-counter-item';
            window.vcCruminaCounterItemView.__super__.changeShortcodeParams.call( this, model );

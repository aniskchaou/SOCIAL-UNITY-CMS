<div class="ui-block">
    <div class="ui-block-title">
        <h6 class="title"><?php esc_html_e( 'Edit Media', 'olympus' ); ?></h6>
    </div>
        ...
        <div class="rtmedia-container rtmedia-single-container rtmedia-media-edit">
            ...
            if ( have_rtmedia() ) : rtmedia();
                if ( rtmedia_edit_allowed() ) {
                        ...
                        <div class="rtmedia-editor-main">
                            <ul class="rtm-tabs clearfix">
                                <li class="active">
                                    <a href="#panel1">
                                        ...
                                        <?php esc_html_e( 'Details', 'olympus' ); ?>
                                    </a>
                                </li>
                            ...
                            <div class="rtm-tabs-content">
                                <div class="content" id="panel1">
                                    ...
                                    <div class="rtmedia-edit-title rtm-field-wrap">
                                        <label><?php esc_html_e( 'Title : ', 'olympus' ); ?></label>
                                    ...
                                    <div class="rtmedia-editor-description rtm-field-wrap">
                                        <label><?php esc_html_e( 'Description: ', 'olympus' ) ?></label>
                                        <?php
                            ...
                            <div class="rtmedia-editor-buttons">
                                <input type="submit" class="button rtm-button rtm-button-save"
                                       onclick="imageEdit.save(<?php echo esc_attr( $rtmedia_media->media_id ) . ', \'' . esc_attr( $media_id_nonce ); ?>')" value="<?php esc_attr_e( 'Save', 'olympus' ); ?>"/>
                    ...
                    ?>
                    <p><?php esc_html_e( 'Sorry !! You do not have rights to edit this media', 'olympus' ); ?></p>
                    <?php
                } else :
                ?>

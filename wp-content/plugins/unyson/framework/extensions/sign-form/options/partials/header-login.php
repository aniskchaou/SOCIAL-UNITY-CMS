	...
	'sign-form-popup' => array(
		...
		'choices' => array(
			...
			'native' => array(
				...
				'sign-form-redirect-to' => array(
					...
					'picker'  => array(
						'sign-form-redirect' => array(
							...
							'label'   => esc_html__( 'Login redirect to', 'olympus' ),
							'choices' => array(
								'current' => esc_html__( 'Current page', 'olympus' ),
								'profile' => esc_html__( 'Profile page', 'olympus' ),
								'activity'  => esc_html__( 'Activity page', 'olympus' ),
					...
					'choices' => array(
						'custom' => array(
							'redirect_to' => array(
								'label' => esc_html__( 'Login redirect URL', 'olympus' ),
								'type'  => 'text',
				...
				'sign-form-redirect-register-to' => array(
					'type' => 'multi-picker',
					'picker'  => array(
						'sign-form-register-redirect' => array(
							'type'    => 'select',
							'value'   => 'current',
							'label'   => esc_html__( 'Register redirect to', 'olympus' ),
							'choices' => array(
								'current' => esc_html__( 'Current page', 'olympus' ),
								'profile' => esc_html__( 'Profile page', 'olympus' ),
								'activity'  => esc_html__( 'Activity page', 'olympus' ),
					...
					'choices' => array(
						'custom' => array(
							'redirect_register_to' => array(
								'label' => esc_html__( 'Register redirect URL', 'olympus' ),
								'type'  => 'text',
							)
						)
					)

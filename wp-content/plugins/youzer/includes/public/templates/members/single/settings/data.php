...
<?php if ( $request ) : ?>
	...
	<?php if ( 'request-completed' === $request->status ) : ?>
		...
		<?php if ( bp_settings_personal_data_export_exists( $request ) ) : ?>
			...
			<p><div id="yz-data-export"><?php printf( '<a href="%1$s"><i class="fas fa-upload"></i>%2$s</a>', bp_settings_get_personal_data_export_url( $request ), esc_html__( 'Download personal data', 'buddypress' ) ); ?></div></p>

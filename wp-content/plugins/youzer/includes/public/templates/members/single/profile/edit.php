...
if ( bp_has_profile( 'profile_group_id=' . bp_get_current_profile_group_id() ) ) :
	...
	<?php
		...
		<?php while ( bp_profile_fields() ) : bp_the_profile_field(); ?>
			...
			<div id="yz_field_<?php bp_the_profile_field_id() ?>" <?php bp_field_css_class( 'editfield' ); ?>>
				<fieldset>
				<?php
				...
				<?php if ( bp_current_user_can( 'bp_xprofile_change_field_visibility' ) ) : ?>
					<p class="field-visibility-settings-toggle" id="field-visibility-settings-toggle-<?php bp_the_profile_field_id() ?>"><span id="<?php bp_the_profile_field_input_name(); ?>-2">
						...
						<button type="button" class="visibility-toggle-link" aria-describedby="<?php bp_the_profile_field_input_name(); ?>-2" aria-expanded="false"><i class="fas fa-cogs"></i><?php _ex( 'Change', 'Change profile field visibility level', 'youzer' ); ?></button>
					</p>
					...
					<div class="field-visibility-settings" id="field-visibility-settings-<?php bp_the_profile_field_id() ?>">
						...
						<button type="button" class="field-visibility-settings-close"><i class="fas fa-times"></i><?php _e( 'Close', 'youzer' ) ?></button>
					</div>
				<?php else : ?>

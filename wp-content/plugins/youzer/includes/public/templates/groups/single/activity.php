...
<div class="item-list-tabs no-ajax" id="subnav" aria-label="<?php esc_attr_e( 'Group secondary navigation', 'youzer' ); ?>" role="navigation">
	<ul>
		<li class="feed"><a href="<?php bp_group_activity_feed_link(); ?>" class="bp-tooltip" data-bp-tooltip="<?php esc_attr_e( 'RSS Feed', 'youzer' ); ?>" aria-label="<?php esc_attr_e( 'RSS Feed', 'youzer' ); ?>"><?php _e( 'RSS', 'youzer' ); ?></a></li>
